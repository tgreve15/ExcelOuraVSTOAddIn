...
namespace ExcelOuraVSTOAddIn
{
    ...
    public class OuraFields
    {
        ...
        private static void SetupDefaultFields()
        {
            ...
            localFields.Add(new OuraFields("Activity Timezone", "Activity", "ActivityTimezone", 35));
            localFields.Add(new OuraFields("Day Start", "Activity", "DayStart", 36));
            localFields.Add(new OuraFields("Day End", "Activity", "DayEnd", 36));
            localFields.Add(new OuraFields("Day Start (local)", "Activity", "DayStartFormatLocal", 37, true, AccessorType.Method));
            localFields.Add(new OuraFields("Day End (local)", "Activity", "DayEndFormatLocal", 37, true, AccessorType.Method));
            localFields.Add(new OuraFields("Cal Active", "Activity", "CalActive", 38));
            localFields.Add(new OuraFields("Cal Total", "Activity", "CalTotal", 39));
            localFields.Add(new OuraFields("Class 5 min", "Activity", "Class5min", 40, false, AccessorType.Property));
            localFields.Add(new OuraFields("Steps", "Activity", "Steps", 41));
            localFields.Add(new OuraFields("Daily Movement", "Activity", "DailyMovement", 42));
            localFields.Add(new OuraFields("Non Wear", "Activity", "NonWear", 43));
            localFields.Add(new OuraFields("Rest", "Activity", "Rest", 44));
            localFields.Add(new OuraFields("Inactive", "Activity", "Inactive", 45));
            localFields.Add(new OuraFields("Low Activity", "Activity", "Low", 46));
            localFields.Add(new OuraFields("Medium Activity", "Activity", "Medium", 47));
            localFields.Add(new OuraFields("High Activity", "Activity", "High", 48));
            localFields.Add(new OuraFields("Inactivity Alerts", "Activity", "InactivityAlerts", 49));
            localFields.Add(new OuraFields("Average Met", "Activity", "AverageMet", 50));
            localFields.Add(new OuraFields("Met 1 min", "Activity", "Met1min", 51, false, AccessorType.Property));
            localFields.Add(new OuraFields("Met Min Inactive", "Activity", "MetMinInactive", 52));
            localFields.Add(new OuraFields("Met Min Low", "Activity", "MetMinLow", 53));
            localFields.Add(new OuraFields("Met Min Medium", "Activity", "MetMinMedium", 54));
            localFields.Add(new OuraFields("Met Min High", "Activity", "MetMinHigh", 55));
            localFields.Add(new OuraFields("Target Calories", "Activity", "TargetCalories", 56));
            localFields.Add(new OuraFields("Target KM", "Activity", "TargetKM", 57));
            localFields.Add(new OuraFields("Target Miles", "Activity", "TargetMiles", 58));
            localFields.Add(new OuraFields("To Target KM", "Activity", "ToTargetKM", 59));
            localFields.Add(new OuraFields("To Target Miles", "Activity", "ToTargetMiles", 60));
            localFields.Add(new OuraFields("Activity Score", "Activity", "ActivityScore", 61));
            localFields.Add(new OuraFields("Score Meet Daily Targets", "Activity", "ScoreMeetDailyTargets", 62));
            localFields.Add(new OuraFields("Score Move Every Hour", "Activity", "ScoreMoveEveryHour", 63));
            localFields.Add(new OuraFields("Score Recovery Time", "Activity", "ScoreRecoveryTime", 64));
            localFields.Add(new OuraFields("Score Stay Active", "Activity", "ScoreStayActive", 65));
            localFields.Add(new OuraFields("Score Training Frequency", "Activity", "ScoreTrainingFrequency", 66));
            localFields.Add(new OuraFields("Score Training Volume", "Activity", "ScoreTrainingVolume", 67));
            localFields.Add(new OuraFields("Activity Rest Mode State", "Activity", "ActivityRestModeState", 68));
            localFields.Add(new OuraFields("Activity Total", "Activity", "ActivityTotal", 69));

            localFields.Add(new OuraFields("Readiness Period Id", "Readiness", "ReadinessPeriodId", 70));
            localFields.Add(new OuraFields("Readiness Score", "Readiness", "ReadinessScore", 71));
            localFields.Add(new OuraFields("Score Activity Balance", "Readiness", "ScoreActivityBalance", 72));
            localFields.Add(new OuraFields("Score HRV Balance", "Readiness", "ScoreHRVBalance", 73));
            localFields.Add(new OuraFields("Score Previous Day", "Readiness", "ScorePreviousDay", 74));
            localFields.Add(new OuraFields("Score Previous Night", "Readiness", "ScorePreviousNight", 75));
            localFields.Add(new OuraFields("Score Recovery Index", "Readiness", "ScoreRecoveryIndex", 76));
            localFields.Add(new OuraFields("Score Resting HR", "Readiness", "ScoreRestingHR", 77));
            localFields.Add(new OuraFields("Score Sleep Balance", "Readiness", "ScoreSleepBalance", 78));
            localFields.Add(new OuraFields("Score Temperature", "Readiness", "ScoreTemperature", 79));
            localFields.Add(new OuraFields("Readiness Rest Mode State", "Readiness", "ReadinessRestModeState", 80));
